...
export default function App() {
  ...
  // Abre sempre com o Rio de Janeiro primeiro — a lista é bem menor que
  // "Todos os estados" (128+ rádios do Brasil inteiro), então a tela
  // inicial carrega bem mais rápido. A pessoa troca pra "Todos os
  // estados" (ou outro estado) no dropdown quando quiser.
